...
$('body').find('.wrap-content .sk-section_of_b_none.common-trustpilot').before($outhtml);
...
$('.checkout-page__foot .foot__upg-text').each(function() {
  $(this).detach().appendTo('.checkout-page__foot .col-md-4 .foot__purchase-wrap');
})