function initjQuery1(callback){var script=document.createElement("script")
...
if(!window.jQuery){initjQuery1(function(){readyjQueryinit1();});}else{readyjQueryinit1();}
var hrf=location.protocol+'//'+location.host+location.pathname;function readyjQueryinit1(){jQuery(function($){var hrf=location.protocol+'//'+location.host+location.pathname;$projectlocation="https://htmldiz.github.io/appointment/";if(hrf=="https://monashivf.com/"){var newBanner='<section id="banner-alternative"> <div class="banner-alternative__container"> <div class="banner-alternative__banner-text"> <h2>Monash IVF Victoria</h2> <p id="js-li-location"></p><ul> <li>Monash IVF was responsible for the world&rsquo;s first IVF pregnancy</li><li>We&rsquo;ve helped over 35,000 couples fall pregnant</li><li>A Monash IVF baby is born every 2.5 hours</li></ul><a class="banner-alternative__btn" href="https://monashivf.com/resources/free-ivf-nurse-chat/" id="cta-button-cro-exp">Book Your Free Nurse Call</a> </div><div class="monash-girl"></div></div></section>';if($('#banner').length){$('#banner').replaceWith(newBanner);}
