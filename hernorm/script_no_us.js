...
window.keradan_ga_event = function(eventAction) {
  ...
  let ga_data = {
    'event': 'event-to-ga',
    'eventCategory': 'Exp - Banners with CTA on articles (non-US)',
...
try {
  ...
  hj('trigger', 'banners_with_CTA_non_US');  
...
let link = 'https://hernorm.com/become-his-obsession/';
let text = 'Learn how to become HIS obsession?';
...
sticky_box.addEventListener('click', () => window.keradan_ga_event('HSO sale'));
