...
$outhtml +=					'<ul class="questions-list">'
...
$outhtml +=							'<div class="question_desc">'
$outhtml +=								'<p>The algorithms that power AI tools in Luminar 4 are complex and intelligent. Still, they are super-easy to use: Luminar allows you to quickly achieve real results that still remain under your control.</p>'
$outhtml +=							'</div>'
$outhtml +=						'</li>'
...
$outhtml +=							'<div class="question_desc">'
$outhtml +=								'<p>Luminar 4 works both in a standalone mode and as a plugin. Photoshop or Lightroom are not required for the app to work. Still, you may install Luminar as a plugin to these applications during the initial setup.</p>'
$outhtml +=							'</div>'
$outhtml +=						'</li>'
